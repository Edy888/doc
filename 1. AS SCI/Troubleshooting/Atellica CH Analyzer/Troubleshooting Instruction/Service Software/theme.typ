...
// --------------------
// Headings (Typst 0.14 SAFE)
// --------------------

// общий стиль заголовков (шрифт/цвет/вес)
...
// отступы вокруг заголовков (ВАЖНО: вставка через #it)
...
#show heading.where(level: 3): it => block(above: 1.3em, below: 0.6em)[#it]
#show heading.where(level: 4): it => block(above: 1.2em, below: 0.5em)[#it]
